...
class RVAE(tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        with tf.GradientTape() as tape:
            ...
            loss_1 = self.compute_loss(x, y, y_pred, z_mean, z_log_var)
        gradients = tape.gradient(loss_1, self.trainable_variables)
    ...
    def test_step(self, data):
        ...
        loss_2 = self.compute_loss(x, y, y_pred, z_mean, z_log_var)
        return {'loss_2': loss_2}
